const LINKS = [
  {
    href: "https://www.linkedin.com/in/ektwr/",
    label: "LinkedIn",
    ...
    <div className={`flex items-center gap-3 ${className}`}>
      {LINKS.map((link) => (
        <a
          ...
          className="inline-flex h-9 w-9 items-center justify-center rounded-lg text-text-muted transition-colors hover:bg-accent-soft hover:text-accent"
        >
